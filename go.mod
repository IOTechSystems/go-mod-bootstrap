...
replace github.com/edgexfoundry/go-mod-configuration/v3 => github.com/IOTechSystems/go-mod-configuration/v3 v3.1.3

replace github.com/edgexfoundry/go-mod-core-contracts/v3 => github.com/IOTechSystems/go-mod-core-contracts/v3 v3.1.19

replace github.com/edgexfoundry/go-mod-messaging/v3 => github.com/IOTechSystems/go-mod-messaging/v3 v3.1.2
