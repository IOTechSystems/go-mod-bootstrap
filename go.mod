...
replace github.com/edgexfoundry/go-mod-configuration/v3 => github.com/IOTechSystems/go-mod-configuration/v3 v3.1.0
...
replace github.com/edgexfoundry/go-mod-registry/v3 => github.com/IOTechSystems/go-mod-registry/v3 v3.1.0
